...
const navItems = [
  ...
  { href: '/caisses', icon: CreditCard, label: 'Caisses & Encaissements' },
  { href: '/stock', icon: Package, label: 'Stock Boissons' },
  { href: '/stands', icon: UtensilsCrossed, label: 'Stands Nourriture' },
  { href: '/personnel', icon: Users, label: 'Personnel & Paie' },
  { href: '/depenses', icon: Receipt, label: 'Dépenses' },
  { href: '/billetterie', icon: Ticket, label: 'Billetterie & Accès' },
  { href: '/rapports', icon: BarChart3, label: 'Rapports & Exports' },
]
